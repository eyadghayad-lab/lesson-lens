...
const Header: React.FC<HeaderProps> = ({ darkMode, setDarkMode, selectedLanguage, setSelectedLanguage }) => {
    ...
    <header className="sticky top-0 z-50 backdrop-blur-md bg-white/70 dark:bg-black/70 border-b border-purple-100 dark:border-purple-900/50">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <a href="landing.html" className="w-10 h-10 bg-gradient-to-tr from-purple-600 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-purple-500/20 hover:scale-110 transition-transform">
        ...
        <div className="flex items-center gap-2 md:gap-4">
          <a href="landing.html" className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-slate-500 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg transition-all">
